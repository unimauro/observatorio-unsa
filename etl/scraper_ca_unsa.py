#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Consulta Amigable MEF -> serie histórica pliego 513 (U.N. DE SAN AGUSTIN DE AREQUIPA).
Drill: Año -> Nivel de Gobierno -> E: GOBIERNO NACIONAL -> Sector 10 EDUCACION -> Pliego 513.
Parsea PIA/PIM/Certificado/Comprometido/Devengado/Girado de la fila 513.
Guarda raw en ca_unsa_raw.json. El merge lo hace merge_presupuesto.py.
...
def main():
    ...
    json.dump({str(y): r for y, r in results.items()},
              open(os.path.join(HERE, "ca_unsa_raw.json"), "w"), ensure_ascii=False)
